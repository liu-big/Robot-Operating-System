...
using namespace std;
#define ODOM_POSE_COVARIANCE2 {1e-3, 0, 0, 0, 0, 0,\
                              0, 1e-3, 0, 0, 0, 0,\
                              0, 0, 1e6, 0, 0, 0,\
                              0, 0, 0, 1e6, 0, 0,\
                              0, 0, 0, 0, 1e6, 0,\
...
#define ODOM_POSE_COVARIANCE {1e-9, 0, 0, 0, 0, 0,\
                              0, 1e-3, 1e-9, 0, 0, 0,\
                              0, 0, 1e6, 0, 0, 0,\
                              0, 0, 0, 1e6, 0, 0,\
                              0, 0, 0, 0, 1e6, 0,\
...
#define ODOM_TWIST_COVARIANCE2 {1e-3, 0, 0, 0, 0, 0,\
                               0, 1e-3, 0, 0, 0, 0,\
                               0, 0, 1e6, 0, 0, 0,\
                               0, 0, 0, 1e6, 0, 0,\
                               0, 0, 0, 0, 1e6, 0,\
...
#define ODOM_TWIST_COVARIANCE {1e-9, 0, 0, 0, 0, 0,\
                                0, 1e-3, 1e-9, 0, 0, 0,\
                                0, 0, 1e6, 0, 0, 0,\
                                0, 0, 0, 1e6, 0, 0,\
                                0, 0, 0, 0, 1e6, 0,\
...
#define ORIENTATION_COVARIANCE {1e6, 0, 0,\
                                0, 1e6, 0,\
                                0, 0, 1e-6}

#define ANGULAR_VELOCITY_COVARIANCE {1e6, 0, 0,\
                                     0, 1e6, 0,\
                                     0, 0, 1e-6}

#define LINEAR_ACCELERATION_COVARIANCE {-1,0,0,\
                                         0,0,0,\
                                         0,0,0}                                    
